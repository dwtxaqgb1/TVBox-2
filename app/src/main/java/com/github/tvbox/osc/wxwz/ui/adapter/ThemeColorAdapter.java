...
public class ThemeColorAdapter extends BaseQuickAdapter<Theme, BaseViewHolder> {
    ...
    public interface ThemeDialogInterface<T> {
    ...
    public ThemeDialogInterface dialogInterface = null;

    public void setDialogInterface(ThemeDialogInterface themeDialogInterface){
        this.dialogInterface = themeDialogInterface;
    }
